...
export type RasterPassName = 'selection' | 'point-shadow-static' | 'point-shadow' | 'shadow-static' | 'shadow' | 'raster' | 'temporal' | 'presentation' | 'gi-primary' | 'gi-trace' | 'gi-update' | 'gi-shade' | 'reflection-trace' | 'reflection-resolve';
